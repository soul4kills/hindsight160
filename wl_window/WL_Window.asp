...
function loadSettings() {
  if (custom_settings.wlw_entries !== undefined && custom_settings.wlw_entries !== "") {
    ...
    wlw_entries = [
      { type:"mac", value:"dc:ef:ca:f5:e8:a3" },
      { type:"mac", value:"f2:7b:8f:d2:74:c2" },
      { type:"mac", value:"34:3e:a4:1f:c7:6f" },
      { type:"mac", value:"68:7a:64:9b:7e:13" },
      { type:"mac", value:"b4:6d:c2:cf:72:28" },
      { type:"mac", value:"f0:b5:d1:57:8f:85" },
      { type:"mac", value:"b4:18:d1:8b:0b:48" },
      { type:"mac", value:"44:39:c4:5a:da:ce" },
      { type:"mac", value:"c4:42:02:1d:48:fe" },
      { type:"mac", value:"32:93:10:98:a0:f3" },
...
function renderTable() {
  ...
  if (wlw_entries.length === 0) {
    ...
    tr.innerHTML = '<td colspan="3">No entries â€” use the form below to add MACs, IPs, or interfaces.</td>';
        ...
        <table width="100%" border="1" align="center" cellpadding="4" cellspacing="0"
          ...
          <tr>
            ...
            <td>
              ...
              <span class="wlw_hint">&nbsp;24-hour â€” block activates at this time nightly</span>
            </td>
          </tr>
          <tr>
            ...
            <td>
              ...
              <input type="text" id="wlw_end_mm" maxlength="2" class="input_6_table"
                     value="00" style="width:38px;text-align:center;" autocorrect="off">
              <span class="wlw_hint">&nbsp;24-hour â€” block is lifted at this time</span>
            </td>
          </tr>
        </table>
